...
def test500_020_ShouldCalculateIntegrate(self):
    myT = T.TCurve(self.nominalN)
    self.assertAlmostEqual(myT.integrate(1,6,myT.f1) , 0.3333, 4 )

     
def test500_030_ShouldCalculateIntegrate(self):
    myT = T.TCurve(self.nominalN)
    self.assertAlmostEqual(myT.integrate(1,6,myT.f2) , 0.5, 3 ) 
        
def test500_040_ShouldCalculateIntegrate(self):
    myT = T.TCurve(self.nominalN)
    self.assertAlmostEqual(myT.integrate(1,6,myT.f3) ,0.142857 , 5 ) 
        
def test500_050_ShouldCalculateIntegrate(self):
    myT = T.TCurve(self.nominalN)
    self.assertAlmostEqual(myT.integrate(1,6,myT.f4) ,0.00990, 5 ) 
